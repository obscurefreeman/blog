...
function resize() {
    ...
    let height = document.querySelector('.canvas-container').offsetHeight;
    // calculate scale ratio
    let scale = width / 600;
    // set zoom value
    illo.zoom = 2 * scale;
    // set illo translate to center of container
    illo.translate = { x: width/2, y: height/2 };
    // update illo
...
//     // illo.rotate.set({});
//     outline_1.rotate.set({});
//     outline_2.rotate.set({});
//     group.rotate.set({});
// };
